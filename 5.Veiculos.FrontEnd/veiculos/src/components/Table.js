    ...
    const actions = [
        {
          ...
          cell: row => <div className="actionsBar">
            <a onClick={() => props.onDetails ? props.onDetails(row) : props.onAction('EDI', row)} data-toggle="tooltip" title="Edit"><img className="buttonIcon" src={FaEdit}/></a>
            <a onClick={() => props.onAction('DEL', row)} data-toggle="tooltip" title="Delete"><img className="buttonIcon" src={FaRegTimesCircle}/></a>
          </div>
        }
    ];
